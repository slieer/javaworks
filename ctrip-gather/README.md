jboss-javaee-webapp: Kitchensink Example using Spring 4.0
==============================================================
...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="org.jboss.tools.examples.controller"/>` 
