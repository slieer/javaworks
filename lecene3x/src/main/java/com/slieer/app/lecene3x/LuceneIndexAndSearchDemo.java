 ...
 * 
 */
package com.slieer.app.lecene3x;
...
public class LuceneIndexAndSearchDemo {
    ...
    public static void main(String[] args) {
        ...
        String text1 = "中文分词 (Chinese Word Segmentation) 指的是将一个汉字序列切分成一个一个单独的词。分词就是将连续的字序列按照一定的规范重新组合成词序列的过程。";
        String text2 = "指的是将一个汉字序列切分成一个一个单独的词。中文分词是文本挖掘的基础,对于输入的一段中文,成功的进行中文分词,可以达到";
...
//            textFild = new TextField(fieldName, text2, Field.Store.YES);
            ...
            QueryParser qp = new QueryParser(Version.LUCENE_4_9, fieldName,
                    analyzer);
